...
# heartbeat is not yet armed: once local-settings.md records `recovery_trigger:`, this stays completely
...
SETTINGS="${CLAUDE_PROJECT_DIR:-.}/.claude/memory/local-settings.md"
[ -f "$SETTINGS" ] || exit 0
