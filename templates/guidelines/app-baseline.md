...
Standing baseline for **any application project bigger than a small script or mini-tool** — the handful of things every such project needs regardless of stack. Each is detailed in its own guideline file; this is the checklist that says they're not optional.
